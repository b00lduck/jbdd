...
define(['DataModule', 'angular-translate', 'angular-ui-grid'], function () {
    ...
    var jbddDataGrid = function ($http, $templateCache, uiGridConstants, $translate, $rootScope, i18nService, $modal,
        ...
        return {
            ...
            templateUrl: 'modules/dataGrid/templates/dataGrid.html',
    ...
    return ['$http', '$templateCache', 'uiGridConstants', '$translate', '$rootScope', 'i18nService',
        '$modal', '$location', 'DataService', jbddDataGrid];
});
