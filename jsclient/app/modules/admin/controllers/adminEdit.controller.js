...
define(['DataModule', 'angular-route', 'angular-translate'], function () {

    var AdminEditController = function ($scope, $routeParams, $location, DataService, $translate, $rootScope) {
    ...
    return ['$scope', '$routeParams', '$location', 'DataService', '$translate', '$rootScope', AdminEditController];
