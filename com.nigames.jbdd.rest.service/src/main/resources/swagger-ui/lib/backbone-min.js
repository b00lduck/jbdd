...
(function (t, e) {
    if (typeof define === "function" && define.amd) {define(["underscore", "jquery", "exports"], function (i, r, s) {t.Backbone = e(t, s, i, r)})} else {
                ...
                if (a = this._events[t]) {
                    ...
                    if (e || r) {
                        for (l = 0, f = a.length; l < f; l++) {
                            n = a[l];
                            if (e && e !== n.callback && e !== n.callback._callback || r && r !== n.context) {s.push(n)}
                        }
                    }
                    if (!s.length) {
    ...
    var c = function (t, e, i, r) {
        ...
        if (l.test(i)) {
            var n = i.split(l);
            for (var a = 0, o = n.length; a < o; a++) {t[e].apply(t, [n[a]].concat(r))}
            return false
        }
        return true
    };
    ...
    i.extend(p.prototype, u, {
        ...
        idAttribute: "id",
        initialize: function () {},
        toJSON: function (t) {return i.clone(this.attributes)},
        sync: function () {return e.sync.apply(this, arguments)},
        get: function (t) {return this.attributes[t]},
        escape: function (t) {return i.escape(this.get(t))},
        ...
        set: function (t, e, r) {
            ...
            for (s in n) {
                ...
                if (!i.isEqual(l[s], e)) {this.changed[s] = e} else {delete this.changed[s]}
                a ? delete c[s] : c[s] = e
            }
            if (!h) {
                if (o.length) {
                ...
                for (var f = 0, d = o.length; f < d; f++) {this.trigger("change:" + o[f], this, c[o[f]], r)}
            }
            if (u) {
                return this;
            }
        ...
        unset: function (t, e) {return this.set(t, void 0, i.extend({}, e, {unset: true}))},
        clear: function (t) {
            var e = {};
        ...
        previousAttributes: function () {return i.clone(this._previousAttributes)},
        fetch: function (t) {
            t = t ? i.clone(t) : {};
            if (t.parse === void 0) {
                t.parse = true;
        ...
        save: function (t, e, r) {
            ...
            if (s && r.wait) {this.attributes = i.extend({}, o, s)}
            if (r.parse === void 0) {
                r.parse = true;
            }
            var h = this;
            ...
            r.success = function (t) {
                ...
                if (i.isObject(e) && !h.set(e, r)) {return false}
                if (u) {
                    u(h, t, r);
                }
        ...
        destroy: function (t) {
            ...
            var e = this;
            var r = t.success;
            var s = function () {e.trigger("destroy", e, e.collection, t)};
            t.success = function (i) {
                if (t.wait || e.isNew()) {
                    s();
                }
        ...
        isValid: function (t) {return this._validate({}, i.extend(t || {}, {validate: true}))},
    ...
    i.extend(g.prototype, u, {
        ...
        sync: function () {return e.sync.apply(this, arguments)},
        add: function (t, e) {return this.set(t, i.extend({merge: false}, e, y))},
        remove: function (t, e) {
            var r = !i.isArray(t);
            t = r ? [t] : i.clone(t);
            e || (e = {});
        ...
        set: function (t, e) {
            ...
            for (s = 0, n = t.length; s < n; s++) {
                h = t[s] || {};
                if (h instanceof p) {a = o = h} else {a = h[f.prototype.idAttribute || "id"]}
                if (u = this.get(a)) {
                    if (x) {
                        _[u.cid] = true;
                    }
            ...
            if (g.length || E && E.length) {
                ...
                if (c != null) {for (s = 0, n = g.length; s < n; s++) {this.models.splice(c + s, 0, g[s])}} else {
                    if (E) {
        ...
        reset: function (t, e) {
            e || (e = {});
            for (var r = 0, s = this.models.length; r < s; r++) {this._removeReference(this.models[r], e)}
        ...
        push: function (t, e) {return this.add(t, i.extend({at: this.length}, e))},
        pop: function (t) {
            var e = this.at(this.length - 1);
            this.remove(e, t);
            return e
        },
        unshift: function (t, e) {return this.add(t, i.extend({at: 0}, e))},
        shift: function (t) {
            var e = this.at(0);
            this.remove(e, t);
            return e
        ...
        sort: function (t) {
            ...
            t || (t = {});
            if (i.isString(this.comparator) || this.comparator.length === 1) {this.models = this.sortBy(this.comparator, this)} else {this.models.sort(i.bind(this.comparator, this))}
            if (!t.silent) {
                this.trigger("sort", this, t);
            }
            return this
        },
        pluck: function (t) {return i.invoke(this.models, "get", t)},
        fetch: function (t) {
            t = t ? i.clone(t) : {};
            if (t.parse === void 0) {
                t.parse = true;
    ...
    i.each(b, function (t) {
        g.prototype[t] = function (e, r) {
            var s = i.isFunction(e) ? e : function (t) {return t.get(e)};
    ...
    i.extend(w.prototype, u, {
        ...
        delegateEvents: function (t) {
            ...
            for (var e in t) {
                ...
                if (a === "") {this.$el.on(n, r)} else {this.$el.on(n, a, r)}
            }
            return this
        },
    ...
    e.sync = function (t, r, s) {
        ...
        if (!s.url) {a.url = i.result(r, "url") || M()}
        ...
        if (a.type !== "GET" && !s.emulateJSON) {a.processData = false}
        if (a.type === "PATCH" && k) {a.xhr = function () {return new ActiveXObject("Microsoft.XMLHTTP")}}
    ...
    i.extend($.prototype, u, {
        ...
        _bindRoutes: function () {
            ...
            while ((t = e.pop()) != null) {this.route(t, this.routes[t])}
        },
        _routeToRegExp: function (t) {
            t = t.replace(I, "\\$&").replace(S, "(?:$1)?").replace(H, function (t, e) {return e ? t : "([^/?]+)"}).replace(A, "([^?]*?)");
    ...
    i.extend(N.prototype, u, {
        ...
        start: function (t) {
            ...
            if (this._hasPushState) {e.$(window).on("popstate", this.checkUrl)} else {
                if (this._wantsHashChange && "onhashchange"in window && !n) {e.$(window).on("hashchange", this.checkUrl)} else {
                    if (this._wantsHashChange) {this._checkUrlInterval = setInterval(this.checkUrl, this.interval)}
                }
            }
            this.fragment = r;
            var o = this.location;
    ...
    var U = function (t, e) {
        var r = this;
        var s;
        if (t && i.has(t, "constructor")) {s = t.constructor} else {s = function () {return r.apply(this, arguments)}}
        i.extend(s, r, e);
        var n = function () {this.constructor = s};
    ...
    var M = function () {throw new Error('A "url" property or function must be specified')};
    var q = function (t, e) {
        var i = e.error;
        e.error = function (r) {
            if (i) {
