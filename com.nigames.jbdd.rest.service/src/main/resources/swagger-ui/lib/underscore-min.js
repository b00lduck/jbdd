...
(function () {
    ...
    h.reduce = h.foldl = h.inject = function (n, t, r, e) {
        ...
        for (e = 0; a > e; e++)if (u = i ? i[e] : e, !t(n[u], u, n)) {
            return !1;
        }
        return !0
        ...
        if (null == t && null != n) {
            ...
            t = h.iteratee(t, r), h.each(n, function (n, r, e) {u = t(n, r, e), (u > a || u === -1 / 0 && i === -1 / 0) && (i = n, a = u)});
        }
        return i
        ...
        if (null == t && null != n) {
            ...
            t = h.iteratee(t, r), h.each(n, function (n, r, e) {u = t(n, r, e), (a > u || 1 / 0 === u && 1 / 0 === i) && (i = n, a = u)});
        }
        return i
    ...
    h.flatten = function (n, t) {return y(n, t, !1, [])}, h.without = function (n) {return h.difference(n, a.call(arguments, 1))}, h.uniq = h.unique = function (n, t, r, e) {
        ...
        var e = n.length;
        for ("number" == typeof r && (e = 0 > r ? e + r + 1 : Math.min(e, r + 1)); --e >= 0;)if (n[e] === t) {
            return e;
        }
        return -1
