 ...
 */
class I18nLongEntitySpec extends Specification {

    def "equals and hashcode contract"() {
        expect:
        EqualsVerifier.forClass(I18nLongEntity)
    ...
    def "#getter/#setter works and is public"() {
        ...
        given:
        def testSubject = new I18nLongEntity()
    ...
    def "getMaxLength"() {
        expect:
        new I18nLongEntity().getMaxLength() == 5000
    }
