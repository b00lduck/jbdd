 ...
 */
class PlayerAssignedBuyableEntityFacetImplSpec extends Specification {

    @Unroll
    def "#getter/#setter works and is public"() {

        given:
        def testSubject = new PlayerAssignedBuyableEntityFacetImpl()
        ...
        "getRemainingBuildtime" | "setRemainingBuildtime" | 42         | long
    }
